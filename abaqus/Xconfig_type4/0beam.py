...
mdb.models['Model-1'].ConstrainedSketch(gridSpacing=167.17, name='__profile__', 
    sheetSize=6686.88, transform=
    mdb.models['Model-1'].parts['beam'].MakeSketchTransform(
    sketchPlane=mdb.models['Model-1'].parts['beam'].datums[3], 
    sketchPlaneSide=SIDE2, 
    sketchUpEdge=mdb.models['Model-1'].parts['beam'].edges[577], 
    sketchOrientation=RIGHT, origin=(99.5, 0.0, 1500.0)))
mdb.models['Model-1'].parts['beam'].projectReferencesOntoSketch(filter=
    COPLANAR_EDGES, sketch=mdb.models['Model-1'].sketches['__profile__'])
del mdb.models['Model-1'].sketches['__profile__']
mdb.models['Model-1'].ConstrainedSketch(gridSpacing=167.17, name='__profile__', 
    ...
    sketchPlane=mdb.models['Model-1'].parts['beam'].datums[3], 
    sketchPlaneSide=SIDE2, 
    sketchUpEdge=mdb.models['Model-1'].parts['beam'].edges[633], 
    sketchOrientation=RIGHT, origin=(99.5, 0.0, 1500.0)))
mdb.models['Model-1'].parts['beam'].projectReferencesOntoSketch(filter=
    COPLANAR_EDGES, sketch=mdb.models['Model-1'].sketches['__profile__'])
mdb.models['Model-1'].sketches['__profile__'].retrieveSketch(sketch=
...
mdb.models['Model-1'].sketches['__profile__'].retrieveSketch(sketch=
    mdb.models['Model-1'].sketches['b04'])
del mdb.models['Model-1'].sketches['__profile__']
mdb.models['Model-1'].ConstrainedSketch(gridSpacing=151.34, name='__profile__', 
    sheetSize=6053.98, transform=
    mdb.models['Model-1'].parts['beam'].MakeSketchTransform(
    sketchPlane=mdb.models['Model-1'].parts['beam'].faces[6], 
    sketchPlaneSide=SIDE1, 
    sketchUpEdge=mdb.models['Model-1'].parts['beam'].edges[14], 
    sketchOrientation=RIGHT, origin=(4.5, 0.0, 2797.658108)))
mdb.models['Model-1'].parts['beam'].projectReferencesOntoSketch(filter=
    COPLANAR_EDGES, sketch=mdb.models['Model-1'].sketches['__profile__'])
mdb.models['Model-1'].sketches['__profile__'].retrieveSketch(sketch=
    mdb.models['Model-1'].sketches['b04'])
mdb.models['Model-1'].sketches['__profile__'].move(objectList=(
    ...
    2797.658108, 0.0))
mdb.models['Model-1'].parts['beam'].PartitionFaceBySketchThruAll(faces=
    mdb.models['Model-1'].parts['beam'].faces.getSequenceFromMask((
    '[#ffffffff:13 #3f ]', ), ), sketch=
    mdb.models['Model-1'].sketches['__profile__'], sketchPlane=
    mdb.models['Model-1'].parts['beam'].faces[6], sketchPlaneSide=SIDE1, 
    sketchUpEdge=mdb.models['Model-1'].parts['beam'].edges[14])
del mdb.models['Model-1'].sketches['__profile__']
# Save by 14analysis on 2018_10_30-18.30.04; build 6.12-1 2012_03_13-20.23.18 119612
...
mdb.models['Model-1'].parts['beam'].PartitionCellByPlanePointNormal(cells=
    ...
    '[#0:2 #1000 ]', ), ), normal=mdb.models['Model-1'].parts['beam'].edges[34]
    , point=mdb.models['Model-1'].parts['beam'].vertices[31])
mdb.models['Model-1'].parts['beam'].PartitionCellByPlanePointNormal(cells=
    mdb.models['Model-1'].parts['beam'].cells.getSequenceFromMask((
    '[#0:2 #2000 ]', ), ), normal=mdb.models['Model-1'].parts['beam'].edges[4], 
    point=mdb.models['Model-1'].parts['beam'].vertices[4])
mdb.models['Model-1'].parts['beam'].PartitionCellByPlanePointNormal(cells=
    mdb.models['Model-1'].parts['beam'].cells.getSequenceFromMask((
    '[#0:2 #4000 ]', ), ), normal=mdb.models['Model-1'].parts['beam'].edges[7], 
    point=mdb.models['Model-1'].parts['beam'].vertices[6])
mdb.models['Model-1'].parts['beam'].PartitionCellByExtrudeEdge(cells=
    mdb.models['Model-1'].parts['beam'].cells.getSequenceFromMask((
    '[#0:2 #8000 ]', ), ), edges=(
    mdb.models['Model-1'].parts['beam'].edges[49], ), line=
    mdb.models['Model-1'].parts['beam'].edges[518], sense=REVERSE)
mdb.models['Model-1'].parts['beam'].PartitionCellByExtrudeEdge(cells=
    mdb.models['Model-1'].parts['beam'].cells.getSequenceFromMask(('[#1 ]', ), 
    ), edges=(mdb.models['Model-1'].parts['beam'].edges[48], ), line=
    mdb.models['Model-1'].parts['beam'].edges[518], sense=REVERSE)
mdb.models['Model-1'].parts['beam'].PartitionCellByExtrudeEdge(cells=
    mdb.models['Model-1'].parts['beam'].cells.getSequenceFromMask(('[#1 ]', ), 
...
mdb.models['Model-1'].parts['beam'].PartitionCellByExtrudeEdge(cells=
    mdb.models['Model-1'].parts['beam'].cells.getSequenceFromMask(('[#1 ]', ), 
    ), edges=(mdb.models['Model-1'].parts['beam'].edges[46], ), line=
    mdb.models['Model-1'].parts['beam'].edges[518], sense=REVERSE)
mdb.models['Model-1'].parts['beam'].PartitionCellByExtrudeEdge(cells=
    mdb.models['Model-1'].parts['beam'].cells.getSequenceFromMask(('[#1 ]', ), 
    ), edges=(mdb.models['Model-1'].parts['beam'].edges[45], ), line=
    mdb.models['Model-1'].parts['beam'].edges[518], sense=REVERSE)
# Save by 14analysis on 2018_10_30-18.37.20; build 6.12-1 2012_03_13-20.23.18 119612
