 ...
 * @author keita
 */
public class CantileverJointModeler {
...
//        double inip=349000;
    ...
    public CantileverJointModeler(String path,double lb,double bk,HSection bsec,KPID kp){
//        int h=550;
//        int h=(int)bsec.getH();
        this.path=path;
        this.bsec=bsec;
    ...
    public void endplate(){
        ...
        dxf.drawLine3D("0",
                ...
                new CoordXYZ(30, dk / 2 + 110, 0));
//        dxf.drawLine3D("0",
//                new CoordXYZ(40+40+30, -dk / 2 - 110, 0),
//                new CoordXYZ(40+40+30, dk / 2 + 110, 0));
//        dxf.drawLine3D("0",
//                new CoordXYZ(40+40+90, -dk / 2 - 110, 0),
//                new CoordXYZ(40+40+90, dk / 2 + 110, 0));
        dxf.drawLine3D("0",
                new CoordXYZ(240, -dk / 2 - 110, 0),
                new CoordXYZ(240, dk / 2 + 110, 0));
        ...
        dxf.drawLine3D("0",
                ...
                new CoordXYZ(0, dk/2 + 110, 0));
//        dxf.drawLine3D("0",
//                new CoordXYZ(240, dk/2 , 0),
//                new CoordXYZ(0, dk/2 , 0));
        dxf.drawLine3D("0",
...
//                new CoordXYZ(0, -dk/2 , 0));
    ...
    public void drawShearPlate1(boolean flag,double offset1,double offset2,DXFDrawer dxf,double hb,bolthole bh){
        ...
        if(hb==400){
            ...
            hs=320;
            w=100;
            x=new double[]{40,40,40,40,40};
            y=new double[]{120,60,0,-60,-120};
