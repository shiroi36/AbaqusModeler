...
import AbaqusModeler.PythonOutputtor.Python_CantileverN_type4;
...
public class makefile_jsce5N {
    ...
    public static void main(String[] args) {
        ...
        KPID[] kp={
            KPID.C490_N16_4M22,KPID.C490_N16_4M22,
            KPID.C490_N16_4M22,KPID.C490_N16_4M22,
            KPID.C490_N16_4M22,KPID.C490_N16_4M22,
            KPID.C490_N16_4M22,KPID.C490_N16_4M22,
        ...
        String path="E:/t2_h600/";
        String path2="E:/t2_h400/";
        ...
        for (int i = 0; i < kp.length; i++) {
            ...
            a.beam();
            a.endplate();
            Python_CantileverN_type4 b = new Python_CantileverN_type4(path, lb[i], lb1[i], bk[i], bsec[i], kp[i]);
            b.main(main[i]);
            b.material();
//            b.part_sp();
            b.part_beam(bmat[i]);
