...
public class makefile2 {
    ...
    public static void main(String[] args) {
        ...
        HSection[] bsec={
            ...
            new HSection(600,200,12,22),
            new HSection(600,200,12,22),
            new HSection(600,200,9,19),
            new HSection(600,200,9,19),
            
            new HSection(600,300,12,25),
            new HSection(600,300,12,25),
            new HSection(600,300,12,19),
            new HSection(600,300,12,19),
        };
        //金物羽根板間直交方向の距離
        double[] bk={
        ...
        path="H:/stype1604/analysis160723x/cae/";
