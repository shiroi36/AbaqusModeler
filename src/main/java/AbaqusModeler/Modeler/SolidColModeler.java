 ...
 * @author keita
 */
public class SolidColModeler {
    
    public static void main(String[] args) {
        double bk=12+24+25;
        double lb=2000;
        KPID kpid=KPID.C400_N25_6M22;
        SolidColModeler bm = new SolidColModeler("colmodel/", 12, 12,
...
//        bm.outputPythonFile("sm490");
    ...
    public SolidColModeler(String path,double tcfr,double tcwr,
            HSection csec,HSection bsec,KPID kp){
//        int h=550;
//        int h=(int)bsec.getH();
        this.bsec=bsec;
        this.path=path;
    ...
    public void drawPanel(double tp){
        ...
        dxf.setHeader();
        double y=bsec.getH()-90;
        double x=csec.getH()-80-2*csec.getFlangeThickness();
        double x1=(tk1+17)/2;
        int num=4;
    ...
    public void drawCFR(){
        ...
        dxf.drawLine3D("0", new CoordXYZ(-x+x1,y+75,0), new CoordXYZ(-x+x1,y-75,0));
        dxf.drawLine3D("0", new CoordXYZ(-x-x1,y+75,0), new CoordXYZ(-x-x1,y-75,0));
        dxf.drawLine3D("0",new CoordXYZ(csec.getB()/2-tcfr-5,y+125,0),new CoordXYZ(csec.getB()/2-tcfr-5,y-125,0));
        dxf.drawLine3D("0",new CoordXYZ(-csec.getB()/2+tcfr+5,y+125,0),new CoordXYZ(-csec.getB()/2+tcfr+5,y-125,0));
        dxf.drawLine3D("0",new CoordXYZ(csec.getB()/2-tcfr-5,y+125,0),new CoordXYZ(-csec.getB()/2+tcfr+5,y+125,0));
        dxf.drawLine3D("0",new CoordXYZ(csec.getB()/2-tcfr-5,y-125,0),new CoordXYZ(-csec.getB()/2+tcfr+5,y-125,0));
    ...
    public void draw(){
        ...
        dxf.drawLine3D("0",new CoordXYZ(-csec.getB()/2+tcfr+5,y+140,0),new CoordXYZ(-csec.getB()/2+tcfr+5,y-130,0));
        dxf.drawLine3D("0",new CoordXYZ(csec.getB()/2,y+140,0),new CoordXYZ(-csec.getB()/2,y+140,0));
...
//        }
//        y=-lb/2+400;
//        dxf.drawLine3D("0",new CoordXYZ(-csec.getB()/2,y,0),new CoordXYZ(csec.getB()/2,y,0));
//        y=-lb/2+400+1.1*csec.getH();
//        dxf.drawLine3D("0",new CoordXYZ(-csec.getB()/2,y,0),new CoordXYZ(csec.getB()/2,y,0));
//        y=-lb/2+lb-50;
//        dxf.drawLine3D("0",new CoordXYZ(-csec.getB()/2,y,0),new CoordXYZ(csec.getB()/2,y,0));
//        dxf.setEnd();
...
//        dxf=new DXFDrawer(outputpath);
//        dxf.setHeader();
//        this.drawShearPlate1(false,-lb/2,0, dxf, csec.getH(), basebolt);
//        dxf.setEnd();
//        dxf.Finish();
//        outputpath=path+"lib/b04.dxf";
//        dxf=new DXFDrawer(outputpath);
//        dxf.setHeader();
//        this.drawShearPlate1(true,-lb/2,20, dxf, csec.getH(), basebolt);
//        dxf.setEnd();
//        dxf.Finish();
